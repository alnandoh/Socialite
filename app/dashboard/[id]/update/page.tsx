...
import { getEventById, updateEvent } from "@/libs/api/api-libs";
...
import EventNameField from "../../create/_components/EventNameField";
import CategoryField from "../../create/_components/CategoryField";
import LocationField from "../../create/_components/LocationField";
import DateField from "../../create/_components/DateField";
import EndDateField from "../../create/_components/EndDateField";
import DescriptionField from "../../create/_components/DescriptionField";
import TicketRows from "../../create/_components/TicketRows";
...
export default function UpdateEventPage() {
    ...
    async function fetchEventData() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setFileName(event.imageUrl ? event.imageUrl.split("/").pop() : null);
          setTicketRows(
            event.tickets.map((_: any, index: any) => ({ id: index }))
          );
        } else {
  ...
  return (
    <div className="p-10 w-full h-full space-y-4">
      <h1 className="text-3xl font-semibold text-center">Update Event</h1>
      <Form {...form}>
